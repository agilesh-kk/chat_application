...
-- ============================================================
-- Web variants — identical logic, prefixed with "web_"
-- Used by the Flutter web data source for separate RPC policies
-- ============================================================

CREATE OR REPLACE FUNCTION web_get_conversations_for_user(p_user_id TEXT)
RETURNS JSONB[]
LANGUAGE plpgsql SECURITY DEFINER
AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION web_fetch_conversation_messages(p_convo_id TEXT)
RETURNS JSONB[]
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
CREATE OR REPLACE FUNCTION web_get_sent_unseen_message_ids(
  p_convo_id TEXT,
  p_sender_id TEXT,
  p_receiver_id TEXT
)
...
CREATE OR REPLACE FUNCTION web_mark_messages_seen(
  p_convo_id TEXT,
  p_user_id TEXT,
  p_receiver_id TEXT
) RETURNS void
...
CREATE OR REPLACE FUNCTION web_toggle_message_reaction(
  p_convo_id TEXT,
  p_message_id TEXT,
  p_user_id TEXT,
  p_emoji TEXT,
...
CREATE OR REPLACE FUNCTION web_edit_conversation_last_message(
  p_convo_id TEXT,
  p_user_id TEXT,
  p_receiver_id TEXT,
  p_message_id TEXT,
...
CREATE OR REPLACE FUNCTION web_send_message_and_update_conversation(
  p_convo_id TEXT,
  p_participants_id TEXT[],
  p_user_id TEXT,
  p_receiver_id TEXT,
...
CREATE OR REPLACE FUNCTION web_update_message_timeline(
  p_convo_id TEXT,
  p_message_id TEXT,
  p_in_timeline BOOLEAN
) RETURNS void
...
CREATE OR REPLACE FUNCTION web_delete_message_and_update_conversation(
  p_convo_id TEXT,
  p_user_id TEXT,
  p_receiver_id TEXT,
  p_deleted_message_id TEXT,
...
CREATE OR REPLACE FUNCTION web_update_conversation_friend_status(
  p_convo_id TEXT,
  p_user_id TEXT,
  p_friend_id TEXT,
  p_is_friend BOOLEAN
