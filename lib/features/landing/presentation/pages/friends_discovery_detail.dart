...
class _FriendsDiscoveryDetailPageState extends State<FriendsDiscoveryDetailPage>
  ...
  void _onScroll() {
    if (!_mockupTriggered && _scrollController.position.pixels > 80) {
      ...
      Future.delayed(const Duration(milliseconds: 200), () => _friend1Anim.forward());
      Future.delayed(const Duration(milliseconds: 400), () => _friend2Anim.forward());
      Future.delayed(const Duration(milliseconds: 600), () => _friend3Anim.forward());
      Future.delayed(const Duration(milliseconds: 800), () => _friend4Anim.forward());
    }
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.people_rounded, color: AppPallete.whiteColor, size: 20),
            SizedBox(width: 10),
